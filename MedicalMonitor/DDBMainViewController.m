...
//                             UIAlertController *alert = [[UIAlertController alloc] initWithTitle:@"Error"
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"ID: %@, Time: %@",item.client_id,item.timestamp];
    cell.detailTextLabel.text = [NSString stringWithFormat:@"channel:%@, value:%f",item.channel,[item.value floatValue]];
